...
{
    public partial class AISetupForm : Form
    {
        ...
        private readonly Color greenColor = Color.FromArgb(70, 210, 125);
        private readonly Color yellowColor = Color.FromArgb(255, 190, 90);
        ...
        public AISetupForm()
        {
            ...
            Resize += AISetupForm_Resize;
            FormClosed += AISetupForm_FormClosed;
        }

        private void ApplyGamingTheme()
        {
            Text = "Player vs AI Setup";
            ...
            Paint += AISetupForm_Paint;

            lblTitle.Text = "PLAYER VS AI";
        ...
        private void CreateInterfaceLabels()
        {
            ...
            lblHeroSub = CreateLabel(
                "CONFIGURE YOUR HUMAN VS AI MATCH",
                new Font(
                    "Segoe UI",
                    9.5F,
                    FontStyle.Bold),
            ...
            lblMatchSub = CreateLabel(
                "HUMAN PILOT  //  ARTIFICIAL OPPONENT",
                new Font(
                    "Consolas",
                    8.5F,
                    FontStyle.Bold),
            ...
            lblThreat = CreateLabel(
                "THREAT LEVEL  //  LOW",
                new Font(
                    "Consolas",
                    7.5F,
                    FontStyle.Bold),
                Color.FromArgb(100, 210, 140));
        ...
        private void CreateSetupPanel()
        {
            ...
            setupPanel.Controls.Add(lblPlayerName);
            setupPanel.Controls.Add(txtPlayerName);
            setupPanel.Controls.Add(lblDifficulty);
            setupPanel.Controls.Add(cmbDifficulty);
            ...
            setupPanel.Controls.Add(lblAIStatus);
            setupPanel.Controls.Add(lblThreat);
        }

        private void SetupControls()
        {
            lblPlayerName.Text = "PLAYER 01";
            lblPlayerName.Font = new Font(
                "Segoe UI",
                10F,
                FontStyle.Bold);

            lblPlayerName.ForeColor = accentBright;
            lblPlayerName.BackColor = Color.Transparent;
            lblPlayerName.AutoSize = false;
            lblPlayerName.Size = new Size(390, 24);
            lblPlayerName.TextAlign =
                ContentAlignment.MiddleLeft;

            txtPlayerName.Font = new Font(
                "Segoe UI",
                11F);

            txtPlayerName.ForeColor = textColor;
            txtPlayerName.BackColor = inputColor;
            txtPlayerName.BorderStyle =
                BorderStyle.FixedSingle;

            txtPlayerName.Size =
                new Size(390, 38);

            txtPlayerName.Cursor =
                Cursors.IBeam;

            lblDifficulty.Text = "AI DIFFICULTY";
            lblDifficulty.Font = new Font(
                "Segoe UI",
                10F,
                FontStyle.Bold);

            lblDifficulty.ForeColor = redBright;
            lblDifficulty.BackColor = Color.Transparent;
            lblDifficulty.AutoSize = false;
            lblDifficulty.Size = new Size(390, 24);
            lblDifficulty.TextAlign =
                ContentAlignment.MiddleLeft;
            ...
            cmbDifficulty.ForeColor = textColor;
            cmbDifficulty.BackColor = inputColor;
            cmbDifficulty.FlatStyle =
                FlatStyle.Flat;

            cmbDifficulty.DropDownStyle =
                ComboBoxStyle.DropDownList;

            cmbDifficulty.DrawMode =
                DrawMode.OwnerDrawFixed;

            cmbDifficulty.ItemHeight = 30;
            cmbDifficulty.Size =
                new Size(390, 38);

            cmbDifficulty.Cursor =
                Cursors.Hand;

            cmbDifficulty.DrawItem +=
                CmbDifficulty_DrawItem;

            cmbDifficulty.SelectedIndexChanged +=
                CmbDifficulty_SelectedIndexChanged;
            ...
            txtPlayerName.KeyDown +=
                PlayerTextBox_KeyDown;
        }
            ...
            string title)
        {
            ...
            button.MouseEnter +=
                GamingButton_MouseEnter;

            button.MouseLeave +=
                GamingButton_MouseLeave;

            button.MouseDown +=
                GamingButton_MouseDown;

            button.MouseUp +=
                GamingButton_MouseUp;
        }
        ...
        private void AISetupForm_Paint(
            object sender,
            PaintEventArgs e)
        {
        ...
        private void CmbDifficulty_DrawItem(
            object sender,
            DrawItemEventArgs e)
        {
            if (e.Index < 0)
        ...
        private void AISetupForm_Resize(
            object sender,
            EventArgs e)
        {
            UpdateLayout();
        ...
        private void AISetupForm_FormClosed(
            object sender,
